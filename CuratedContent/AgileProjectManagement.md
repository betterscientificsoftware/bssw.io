...
[The United States Research Software Engineer Association (US RSE)](https://us-rse.org/) presented the webinar, [Agile Project Management](https://youtu.be/Fdex2rhw0Zo) on October 19, 2022. The first six minutes of the webinar is an overview of [US RSE](https://us-rse.org/), a community organization for those who write and contribute to research software. After the US RSE overview, Angela Herring presents the main topic, explaining how to modify the agile process, Scrum, to do science.

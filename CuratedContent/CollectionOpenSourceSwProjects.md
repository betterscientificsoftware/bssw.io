...
<!-- deck text start -->
What better way to keep a collection of important documents to help OSS Projects than an open-source repository. The repository is a collection of documents for guidance, governance, examples, and templates for OSS projects. As with any open source project, contributions are encouraged.
<!-- deck text end -->

...
:--- | :---
Article Title | [AI & Humans: Making the Relationship Work](https://www.schneier.com/blog/archives/2026/01/ai-humans-making-the-relationship-work.html)
Authors | Bruce Schneier and Nathan E. Sanders
Focus | AI Tools for Software Development

As so many of us explore the integration of AI into our development workflows, how is that changing the way we work together or manage our projects?  This is the question investigated in Schneier and Sanders essay/blog post with some interesting results.  Results that point to both the importance of having mixed teams of humans and AI agents, along with these teams being governed by timeworn management practices known for decades.

While not science or research specific, the results reported in the blog apply equally to the development and execution of scientific software since so many of our projects are large-scale multi-team efforts identical in most respects to the teams researched by the authors.

...
This repository provides source material for the (still under construction) [BetterScientificSoftware.io](https://betterscientificsoftware) web portal. Better Scientific Software (BSSw) community members can contribute content using standard GitHub tools and processes. Contributions can be made via:

...
<!-- begin deck -->
But UX isn't a "one-and-done" step – it's a toolkit that applies at every turn. In practice, every stage of a project has a few usability questions worth answering.
<!-- end deck -->
...
- **Usability testing:** a [Carpentries Incubator lesson on rapid usability testing](https://carpentries-incubator.github.io/rapid-usability-tutorial/index.html), covering everything from participant recruitment through data analysis.
- **Semi-structured interviews:** a [presentation on practical techniques for gathering rich data from users](https://zenodo.org/records/17362664), hosted on Zenodo.
- **Heuristic evaluation:** A [template for assessing your software against design heuristics](https://github.com/cass-community/heuristics-for-scisoft), suitable for both CLI and GUI tools, developed by contributions from the STRUDEL, PESO, and CASS projects.
- For a broader starting point, the STRUDEL project's *[Ten Principles for Creating Usable Software for Science](https://escholarship.org/content/qt0w5547jv/qt0w5547jv_noSplash_fb5d052988314657a264f28acb6ffc95.pdf)* explains what makes scientific software different and how to approach its usability.

## Author bios

Md Hasan Shahriar Simanto is a Senior UX Researcher at MathWorks, where he conducts user research for MATLAB, a scientific computing platform used by engineers and scientists. Since 2018, his work has focused on human-centered research and usability across scientific software, cloud infrastructure, cybersecurity, and enterprise systems, with current work centered on the usability of AI-assisted technical workflows. He is an active member of the US-RSE UX Working Group. Reach him at hsimanto@mathworks.com.

Rajshree Deshmukh is a User Experience Designer at Lawrence Berkeley National Laboratory's Scientific Data Division, where she designs intuitive software products and contributes to projects including NERSC, STRUDEL, and the Orphaned Wells project. She has over nine years of industry experience at Reuters, IBM, and Nutanix, and holds a Master's in Information Design from the National Institute of Design, India. Reach her at rajshreed@lbl.gov.

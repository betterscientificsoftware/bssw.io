...
- Interested in joining communities of practice for UX in science?
  - The US-RSE community and its User Experience working group offer the opportunity to engage with others about UX or identify resources to help your own software team. [https://us-rse.org/wg/ux/](https://us-rse.org/wg/ux/) Complete this [form](https://docs.google.com/forms/d/e/1FAIpQLSdJbPczGHFN8mfMFu_YQym508OzFtOZxfSzr1sOoINxaMmiaw/viewform) for an invitation to their Slack space.
  - The Consortium for the Advancement of Scientific Software (CASS) [User-Developer Experience (UDX) working group](https://cass.community/working-groups/user-developer-experience.html) holds [monthly meetings](https://cass.community/working-groups/user-developer-experience.html#-userdeveloper-experience-webinars), alternating between organized presentations and open discussions, open to all. To join, register for the [open discussion sessions](https://lbnl.zoom.us/meeting/register/sKF_cgTrQf2QNWJTwHoHuw) (even months) or the [webinar sessions](https://lbnl.zoom.us/meeting/register/uecckzcDSO6FIaQuMMhMvg) (odd months), according to your interests.

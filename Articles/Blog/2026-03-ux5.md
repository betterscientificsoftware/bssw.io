...
To join US-RSE and the UX working group, fill out this [form](https://docs.google.com/forms/d/e/1FAIpQLSdJbPczGHFN8mfMFu_YQym508OzFtOZxfSzr1sOoINxaMmiaw/viewform) for an invitation to the Slack space, then join the #wg-ux channel. To join the CASS UDX working group, register for the [open discussion sessions](https://lbnl.zoom.us/meeting/register/sKF_cgTrQf2QNWJTwHoHuw) (even months) or the [webinar sessions](https://lbnl.zoom.us/meeting/register/uecckzcDSO6FIaQuMMhMvg) (odd months), according to your interests. Have thoughts on these or other strategies for growing communities of practice? Reach out!
...
- Interested in joining communities of practice for UX in science?
  ...
  - The Consortium for the Advancement of Scientific Software (CASS) User-Developer Experience (UDX) working group holds monthly meetings, alternating between organized presentations and open discussions, open to all. <https://cass.community/working-groups/user-developer-experience.html>. To join, register for the [open discussion sessions](https://lbnl.zoom.us/meeting/register/sKF_cgTrQf2QNWJTwHoHuw) (even months) or the [webinar sessions](https://lbnl.zoom.us/meeting/register/uecckzcDSO6FIaQuMMhMvg) (odd months), according to your interests.

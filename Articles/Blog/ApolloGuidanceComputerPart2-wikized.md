...
But, in the 1960s where there were no DevOps<sup>[37]</sup> best practices and collaborative tools
...
language<sup>[12]</sup> but also by using some of these lower-level pieces.
...
then be stored in fixed memory. Another example is a list of stars<sup>[46]</sup>
...
For every phase of the mission, *the AGC had an app for that*.<sup>[44]</sup>
...
(major mode P63), Approach (P64), Terminal Descent (P66) and Touchdown (P68).<sup>[4]</sup>
...
the Moon's lump gravity field;<sup>[1],[2]</sup> and precision timing to coordinate
...
execution during the burn.<sup>[45]</sup>
...
and increased performance.<sup>[5],[10]</sup>
...
The software effort was about $60M<sup>[16],[17]</sup> ($500M in 2019 dollars), the majority
...
A 1972 master's thesis<sup>[16]</sup> breaks down software costs by
...
costs down, there was even a computer-automated documentation system developed.<sup>[42]</sup>
...
development. In August 1969, the uncrewed Russian probe Zond-7<sup>[47]</sup>
guided by an Argon-11S<sup>[43]</sup> digital computer completed the first fully
...
[44]: #ref44 "AGC CM Major Mode Programs"
[45]: #ref45 "AGC CM DAP Configuration"
[46]: #ref46 "AGC CM Star Names"
[47]: #ref47 "Russian Zond-7 Mission"
...
<a name="ref44"></a>44 | [AGC CM Major Mode Programs ](https://www.ibiblio.org/apollo/CMC_data_cards_15_Fabrizio_Bernardini.pdf?#page=25)
<a name="ref45"></a>45 | [AGC CM DAP Configuration ](https://www.ibiblio.org/apollo/CMC_data_cards_15_Fabrizio_Bernardini.pdf?#page=31)
<a name="ref46"></a>46 | [AGC CM Star Names ](https://www.ibiblio.org/apollo/CMC_data_cards_15_Fabrizio_Bernardini.pdf?#page=29)
<a name="ref47"></a>47 | [Russian Zond-7 Mission ](https://en.wikipedia.org/wiki/Zond_7)
<!--- WARNING: DO NOT EDIT! Auto-generated with wikize_refs.py from ApolloGuidanceComputerPart2.md --->

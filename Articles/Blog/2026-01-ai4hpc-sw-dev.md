...
- The second paper, “[AI Assistants to Enhance and Exploit the PETSc Knowledge Base](https://doi.org/10.1145/3750720.3757281),” was presented by Junchao Zhang (Argonne National Laboratory). The work showcased how industry-driven AI technologies can enhance the development process of well-established libraries, with focus on the Portable, Extensible Toolkit for Scientific Computation (PETSc), widely used in HPC. The paper highlights the fact that, as a mature library, PETSc has a great deal of valuable, but unstructured, information available, so there is a need to adapt this knowledge, along with the niche nature of HPC, to make LLMs more effective for their developer and user community.  

# Apollo Series Part 1: When 100 FLOPS/Watt Was a Giant Leap
...
control (GNC) system for manned Apollo missions<sup>[3],[8]</sup> was an
...
been involved in development of the Polaris missile GNC system.<sup>[16]</sup>
...
Semiconductor<sup>[17]</sup> in an area that would eventually become known as
Silicon Valley.<sup>[24],[25]</sup> At its peak, the effort consumed over 60%
...
special-purpose registers.<sup>[15]</sup> The table below compares key AGC
...
computer, ILLIAC IV,<sup>[21]</sup> were completed. Costing nearly $5 billion
to develop, 20% of the entire Apollo budget, IBM's System 360 was a big gamble
and even bigger success.<sup>[29]</sup> In the table below, we also include a
row for comparison with IBM’s newest AC922<sup>[26]</sup> based systems
(Summit<sup>[19]</sup> / Sierra<sup>[23]</sup>).

<br> 

System | Kb | Flops (F) | (Watts) F/W | (Kg) F/Kg | (m<sup>3</sup>) F/m<sup>3</sup>
:--- | :---: | :---: | :---: | :---: | :---:
AGC Block II<sup>[11]</sup> | 76 | 14,245 | (55) 259.0 | (32) 445 | (00.03) 50000
IBM 360-20<sup>[9],[10]</sup> | 32 | 3,011 | (5000) 0.6 | (600) 5 | (30.00) 100
IBM AC922<br>(Summit<sup>[19],[20],[23]</sup>) | 1E12 | 14E16| (97E5) 14E9 | (31E4) 45E10 | (930) 15E13

<sup>a</sup>FLOP = single precision multiply + add

### Rope core: A new type of nonvolatile memory

The AGC utilized two types of *core* memory<sup>[13]</sup>: erasable memory
using coincident current cores and fixed (read-only) memory using rope
cores,<sup>[14]</sup> technology specifically designed for and unique to the
...
labor to hand-weave<sup>[12]</sup> thin wires through (logical ‘1’) or around
...
back more than 150 years *earlier* to the Jacquard loom.<sup>[22],[27]</sup>
...
critical programs were restart protected.<sup>[18]</sup> This involved careful
...
complicated testing. In 1968, an internal NASA report<sup>[18]</sup> raised
...
assembly code<sup>[30]</sup>. However, solving complex, 3D spatial navigation
...
and other miscellaneous control-flow functions. Similar to p-code,<sup>[32]</sup>
...
divided into two stages. Depending on the phase of a mission<sup>[35]</sup>,
...
4 hardware faults were observed,<sup>[11]</sup> none of which occurred in
...
development of this revolutionary new computer to support it.<sup>[34]</sup>
Half a century later, self-driving is so critical for Telsa, they have
developed a custom, proprietary AI chip to support it.<sup>[31]</sup>
...
[1]: #ref1 "Overview of Apollo 11 Mission"
[2]: #ref2 "List of Moon missions since 1958"
[3]: #ref3 "What is Primary Guidance, Navigation and Control"
[4]: #ref4 "Whole book: 'Apollo Guidance Computer Architecture and Operation'"
[5]: #ref5 "Overview of AGC Architecture"
[6]: #ref6 "YouTube Video of Rope Core Manufacture"
[7]: #ref7 "Computer-Controlled Steering of the Apollo Spacecraft"
[8]: #ref8 "MIT Technical Report on Apollo Guidance and Navigation"
[9]: #ref9 "IBM 360/20 Specs"
[10]: #ref10 "IBM 360 Detailed Installation Manual"
[11]: #ref11 "Reliability History of the AGC"
[12]: #ref12 "Weaving Rope Core Memory"
[13]: #ref13 "Description of Core Memory"
[14]: #ref14 "Description of Rope Core Memory"
[15]: #ref15 "Amazingly Detailed Presentation on Architecture and Operation of the AGC"
[16]: #ref16 "Polaris Guidance System"
[17]: #ref17 "Historical Note about Fairchild Semiconductor"
[18]: #ref18 "AGC Restart System Design"
[19]: #ref19 "ORNL Launch of Summit"
[20]: #ref20 "Top Green 500 List, November 2018"
[21]: #ref21 "Description of Illiac IV"
[22]: #ref22 "Jacquard Loom & Computing"
[23]: #ref23 "LLNL Description of Sierra"
[24]: #ref24 "Historical Impact of AGC on Computing Technology"
[25]: #ref25 "Historical Impact of AGC on Chip Manufacture"
[26]: #ref26 "Description of IBM AC922 Systems"
[27]: #ref27 "Illustrated History of Computers"
[28]: #ref28 "Rope Memory Description"
[29]: #ref29 "IBM $5B Gamble with System 360"
[30]: #ref30 "AGC Assembly Language Manual"
[31]: #ref31 "Tesla's new AI Chip"
[32]: #ref32 "Example of a P-code language"
[33]: #ref33 "NASA archive on Computers in Spaceflight"
[34]: #ref34 "The need for an on-board computer"
[35]: #ref35 "NASA Apollo flight plan diagram created by NASA in 1967 to illustrate the flight path and key mission events for the upcoming Apollo missions to the Moon. To allow our readers to explore the image in more detail we include a link to the full-res image here."

<br>

References | &nbsp;
:--- | :---
<a name="ref1"></a>1 | [Overview of Apollo 11 Mission ](https://www.nasa.gov/mission_pages/apollo/missions/apollo11.html)
<a name="ref2"></a>2 | [List of Moon missions since 1958 ](https://en.wikipedia.org/wiki/Moon_landing)
<a name="ref3"></a>3 | [What is Primary Guidance, Navigation and Control ](https://en.wikipedia.org/wiki/Apollo_PGNCS)
<a name="ref4"></a>4 | [Whole book: 'Apollo Guidance Computer Architecture and Operation' ](ftp://ssh.esac.esa.int/pub/ekuulker/Apollo15/The-Apollo-Guidance-Computer-Architecture-and-Operation.pdf)
<a name="ref5"></a>5 | [Overview of AGC Architecture ](https://en.wikipedia.org/wiki/Apollo_Guidance_Computer)
<a name="ref6"></a>6 | [YouTube Video of Rope Core Manufacture ](https://youtu.be/YIBhPsyYCiM)
<a name="ref7"></a>7 | [Martin FH, Battin RH. 1968. Computer-Controlled Steering of the Apollo Spacecraft. J Spacecraft. 5(4):400-7](https://pdfs.semanticscholar.org/0d44/2a1b41da2ccbffeda8aa2e1a7c2417ac71e0.pdf)
<a name="ref8"></a>8 | [MIT Technical Report on Apollo Guidance and Navigation ](https://www.ibiblio.org/apollo/hrst/archive/1713.pdf)
<a name="ref9"></a>9 | [IBM 360/20 Specs ](https://en.wikipedia.org/wiki/IBM_System/360_Model_20)
<a name="ref10"></a>10 | [IBM 360 Detailed Installation Manual ](http://www.bitsavers.org/pdf/ibm/360/fe/GC22-6820-12_System_360_Installation_Manual_Physical_Planning.pdf)
<a name="ref11"></a>11 | [Reliability History of the AGC ](https://www.ibiblio.org/apollo/klabs/history/history_docs/r713.pdf)
<a name="ref12"></a>12 | [Weaving Rope Core Memory ](https://youtu.be/P12r8DKHsak)
<a name="ref13"></a>13 | [Description of Core Memory ](https://en.wikipedia.org/wiki/Magnetic-core_memory)
<a name="ref14"></a>14 | [Description of Rope Core Memory ](https://en.wikipedia.org/wiki/Core_rope_memory)
<a name="ref15"></a>15 | [Amazingly Detailed Presentation on Architecture and Operation of the AGC ](https://youtu.be/xx7Lfh5SKUQ)
<a name="ref16"></a>16 | [Polaris Guidance System ](https://www.computerhistory.org/revolution/real-time-computing/6/128/529)
<a name="ref17"></a>17 | [Historical Note about Fairchild Semiconductor ](https://en.wikipedia.org/wiki/Fairchild_Semiconductor)
<a name="ref18"></a>18 | [AGC Restart System Design ](https://www.ibiblio.org/apollo/hrst/archive/1033.pdf)
<a name="ref19"></a>19 | [ORNL Launch of Summit ](https://www.ornl.gov/news/ornl-launches-summit-supercomputer)
<a name="ref20"></a>20 | [Top Green 500 List, November 2018 ](https://www.top500.org/green500/list/2018/11/)
<a name="ref21"></a>21 | [Description of Illiac IV ](https://en.wikipedia.org/wiki/ILLIAC_IV)
<a name="ref22"></a>22 | [Jacquard Loom & Computing ](https://en.wikipedia.org/wiki/Jacquard_loom#Importance_in_computing)
<a name="ref23"></a>23 | [LLNL Description of Sierra ](https://hpc.llnl.gov/hardware/platforms/sierra)
<a name="ref24"></a>24 | [Historical Impact of AGC on Computing Technology ](https://www.computerworld.com/article/2525898/app-development/nasa-s-apollo-technology-has-changed-history.html)
<a name="ref25"></a>25 | [Historical Impact of AGC on Chip Manufacture ](https://airandspace.si.edu/stories/editorial/apollo-guidance-computer-and-first-silicon-chips)
<a name="ref26"></a>26 | [Description of IBM AC922 Systems ](https://www.ibm.com/us-en/marketplace/power-systems-ac922)
<a name="ref27"></a>27 | [Illustrated History of Computers ](http://www.computersciencelab.com/ComputerHistory/History.htm)
<a name="ref28"></a>28 | [Rope Memory Description ](https://youtu.be/P12r8DKHsak?t=35)
<a name="ref29"></a>29 | [IBM $5B Gamble with System 360 ](https://www.telegraph.co.uk/technology/news/10719418/IBMs-5bn-gamble-revolutionary-computer-turns-50.html)
<a name="ref30"></a>30 | [AGC Assembly Language Manual ](https://www.ibiblio.org/apollo/assembly_language_manual.html)
<a name="ref31"></a>31 | [Tesla's new AI Chip ](https://www.theverge.com/2019/4/22/18511594/tesla-new-self-driving-chip-is-here-and-this-is-your-best-look-yet)
<a name="ref32"></a>32 | [Example of a P-code language ](https://en.wikipedia.org/wiki/P-code_machine)
<a name="ref33"></a>33 | [NASA archive on Computers in Spaceflight ](https://history.nasa.gov/computers/Part1.html)
<a name="ref34"></a>34 | [The need for an on-board computer ](https://history.nasa.gov/computers/Ch2-1.html)
<a name="ref35"></a>35 | [NASA Apollo flight plan diagram created by NASA in 1967 to illustrate the flight path and key mission events for the upcoming Apollo missions to the Moon. To allow our readers to explore the image in more detail we include a link to the full-res image here. ](https://github.com/betterscientificsoftware/images/raw/master/397_apollo_flightdiagram.jpg)

...
**Hero Image:**
 ...
 - <img src='https://github.com/betterscientificsoftware/images/raw/master/Blog_1120_PSIP_HDF5_BlackHole.png' />
...
<!-- LCM: Matt: graph image goes here. Caption: Figure 1. Use of PSIP helps teams to improve software practices, with productivity boosts that quickly recapture the initial investment as well as any costs due to disruption of existing processes.. -->
...
2. **Improvement Goal #2 (IG2)**: Move HDF5 from a THG managed Bitbucket instance to GitHub
3. **Improvement Goal #3 (IG3)**: Define and adopt a set of consistent coding standards
...
<!-- LCM: Matt: PTC images goes here. Caption: Figure 2. PSIP progress tracking cards that represent the incremental steps used to address process improvement goals in documentation, use of GitHub for revision control, and coding standards. -->
...
Elena Pourmal is XXX ... short bio goes here.

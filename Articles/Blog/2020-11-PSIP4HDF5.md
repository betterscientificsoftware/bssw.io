...
**Hero Image:**
 ...
 - <img src='https://github.com/betterscientificsoftware/images/raw/master/Blog_1120_PSIP_HDF5_BlackHole.png' />[Simulation of black hole merger using the HDF5 high-performance data model and library.]
...
the [Productivity and Sustainability Improvement Planning (PSIP)](https://bssw-psip.github.io/) methodology was gainfully employed to effect key process improvements in the HDF5 project:
the introduction of a docs-like-code workflow for documentation, migration of the HDF5 code base
to GitHub, and the adoption of coding standards with the flexibility to permit automated conversion. Key take aways:
* PSIP is significantly more lightweight than other approaches.
* PSIP relieves team members of the baggage of having to learn a lot of special verbiage or terminology.
* PSIP is more hands-on and practical, as well as less abstract, than more classical methodologies.
...
***[Figure 1 goes here ... Caption: Use of PSIP helps teams to improve software practices, with productivity boosts that quickly recapture the initial investment as well as any costs due to disruption of existing processes.]***
...
As shown in the table below, work kicked off with a two-hour training where PSIP facilitators led The HDF Group (THG) staff, comprised of a mix
...
* **Improvement Goal #1 (IG1)**: Modernize processes for handling various forms of documentation
* **Improvement Goal #2 (IG2)**: Move HDF5 from a THG managed Bitbucket instance to GitHub
* **Improvement Goal #3 (IG3)**: Define and adopt a set of consistent coding standards

THG staff members then self-organized around the IG(s) they were passionate about drafting and refining an
associated PTC (see images below). Developing quality [PTCs](https://bssw-psip.github.io/practice-guides/how_to_create_ptc.html)
...
***[Figure 2 goes here ... Caption: Figure 2. PSIP progress tracking cards represent the incremental steps used to address process improvement goals in documentation, use of GitHub for revision control, and coding standards.]***
...
process improvements. For even smallish scientific code teams of 2-4 FTEs, the $150K here likely
...
Elena Pourmal is the Director of Technical Services and Operations of [The HDF Group](https://www.hdfgroup.org/) ... short bio goes here.

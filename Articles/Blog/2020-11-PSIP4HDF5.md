...
* **Improvement Goal #1 (IG1)**: Modernize processes for handling various forms of documentation ([PTC](https://bssw-psip.github.io/ptc-catalog/catalog/THGReferenceManual.html))

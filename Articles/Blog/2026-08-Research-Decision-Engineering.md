...
Software Gardening<sup>[1],[2]</sup> encourages us to think of scientific software as a living system requiring sustained, intentional stewardship, and every garden moves through seasons. In this one, generative tools have become part of many developers' daily workflows: software capable of producing code, tests, documentation, and architectural suggestions from natural language descriptions. These technologies, from large language models to agent-based coding assistants, share a capacity to generate at a speed and breadth no individual developer could match alone. The work is still about cultivating healthy, sustainable, scientifically sound software; what this season asks of the gardener is a sharper focus on judgment, framing, and direction as the primary instruments of stewardship.

That focus has always been part of gardening practice. What the generative era makes visible is how much of the gardener's most consequential work has never been about writing code at all, but about deciding what to grow, where, and why. These tools do not eliminate technical decisions so much as redistribute them, creating space to operate at a higher level of abstraction. That redistribution carries a risk: when a developer stops directing and starts only accepting, the result is **slop**, generative output produced without critical evaluation or deliberate intent.<sup>[12]</sup> Slop is cognitive surrender, the moment when speed substitutes for judgment and volume displaces meaning. The deliberate counter-practice is **research decision engineering**: tending the garden's direction with the same care that earlier seasons devoted to tending its code.

### What is decision engineering?

**Decision engineering** is the practice of framing problems precisely enough for tools or colleagues to act on them, evaluating the outputs produced, verifying correctness against real-world requirements, steering system architecture toward sustainable designs, and maintaining clarity about what problem is actually worth solving. It describes a dimension of software development that has always existed; the generative era gives it greater visibility and impact as the scope of what a single developer can initiate grows dramatically.

**Research decision engineering** is this practice applied under the distinctive pressures of scientific software: correctness is non-negotiable; reproducibility is a community expectation rather than a best practice; software often serves a specific hypothesis rather than a general user population; and the product owner is frequently the same person writing the code. These conditions make the judgment calls of decision engineering both harder and more consequential than in many commercial settings, and they make a dedicated vocabulary for the practice more valuable.
...
Two neighboring disciplines have been practicing versions of it for decades, and RSEs can learn considerably from both.
...
[13-sfer-ezikiw]: https://doi.org/10.1207/s15516709cog1204_1 "Cognitive apprenticeship {Collins, A., Brown, J. S. & Newman, S. E. Cognitive apprenticeship: Teaching the crafts of reading, writing, and mathematics. In L. B. Resnick (Ed.), Knowing, Learning, and Instruction: Essays in Honor of Robert Glaser (pp. 453–494). Lawrence Erlbaum Associates (1989). doi:10.1207/s15516709cog1204_1.}"
...
* <a name="sfer-ezikiw-13"></a><sup>13</sup>[Collins, A., Brown, J. S. & Newman, S. E. Cognitive apprenticeship: Teaching the crafts of reading, writing, and mathematics. In L. B. Resnick (Ed.), Knowing, Learning, and Instruction: Essays in Honor of Robert Glaser (pp. 453–494). Lawrence Erlbaum Associates (1989).](https://doi.org/10.1207/s15516709cog1204_1)

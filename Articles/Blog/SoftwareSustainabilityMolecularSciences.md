...
software sustainability. This blog article will discuss some of the software
sustainability challenges and the opportunities/possible solutions that the
is working toward with the molecular sciences software development community.
...
2016, the goals of the MolSSI are to provide software expertise and
...
common for most of the rest of the molecular sciences software ecosystem. This
means that sharing of software is not as easy as it should be. Also, new or
...
developed) at the time of these early programs. In addition, there was generally
no formal training of molecular scientists in the computer sciences including
...
amount of course work and adding additional requirements can be difficult,
...
documentation, communication among the software developers, etc. It must be
understood that developing this community can take time and effort, and
therefore, expense. In addition the software development must align with the
user needs. Consistent and frequent communication with potential and existing
users is necessary to ensure that the demand will be high. Factors that
...
software is often not the primary focus; it is just a vehicle used towards a
publication - the primary metric still used in most science fields. This can
lead to developers skipping the necessary upfront cost for clear and effective
design decisions, taking shortcuts in the development to "just get the software
working," skipping testing for end cases, and putting off documentation (that
then never appears). This can make the software difficult to maintain and,
...
the social environment is changing, it is still true that software is not
considered as important of a product as a publication, although projects such as
...
molecular sciences. While these careers can be very satisfying, it leads to some
of the best computational engineers being enticed out of the very field that
needs them.
...
field. In addition, materials are made available online in a tutorial form for
...
and partnered with the [Better Scientific Software](https://bssw.io/) effort to
...
graduate students and postdocs with the intent of providing of in-depth training
in software best practices and engineering. These educational opportunities are
making a foothold in the community and we expect there will be long-term impact
...
open discussions on bottlenecks to software development as well as issues
...
community. It should be noted that most of these workshops are led by members of
...
[QCArchive](https://qcarchive.molssi.org)) and for enabling the coupling of
...
sustainability challenges. However, the MolSSI works to practice what it
preaches: designing and developing with its users (mostly developers of
...
reward those who take the software development path - other than a large salary
at an industrial position not related to molecular sciences. These efforts
include encouraging developers to use DOIs for their software and datasets,
raising the level of a software release to the same level as a publication, the
use of data within tools like GitHub to show productivity, and encouraging the
...
Liberal Arts and Sciences Dean Professor at Iowa State University and a
...
DOE Exascale Computing Project and Deputy Director of MolSSI. Her research
